...
<body>
    ...
    <section class="schedule-section bg-light py-5" style="margin-top:100px;">
        <div class="container">
                ...
                <div class="card-body">
                    ...
                    <form id="scheduleForm" action="../../api/interviews.php" method="POST" novalidate>
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="internshipSelect">Choose Internship</label>
                        ...
                        <div class="text-center mt-3">
                            <button class="btn btn-success px-5 py-2 fw-semibold" type="submit">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-success text-white">
                                    <h5 class="modal-title" id="confirmModalLabel">Interview Confirmed</h5>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body text-center">
                                    <i class="bi bi-check-circle-fill text-success display-4"></i>
                                    <p class="mt-3">Your interview has been scheduled successfully.</p>
                                    <p class="small text-muted mb-0" id="interviewDetails"></p>
                                </div>
                                <div class="modal-footer justify-content-center">
                                    <a href="dashboard.html" class="btn btn-success px-4">Back to Dashboard</a>
                                </div>
                            </div>
                        </div>
                    </div>
